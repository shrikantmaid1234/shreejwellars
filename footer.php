<!--Footer Part Start-->
	<footer id="footerWrapper" class="clear">
        	...
        	<div class="column">
          	...
          	<div class="column">
				...
				<ul>
              		...
              		<li><img src="image/phone.png" width="14px" height="14px"> 9890964512</li>
              		<li><a href="#" onmouseover="showAddress();" onmouseout="hideAddress();">Address</a></li>
				</ul>
				<div id="AddressDiv" class="AddressDiv">
					<p><b>Taklibahn Tal-shrirampur Dist-Ahmadnage</b></p>
					<p><b>Pincode-413719</b></p>
				</div>
          	</div>
          	<div class="column">
            	<h3>Extras</h3>
        ...
        <div class="powered-main">
        	<div id="powered"> Designed By <a href=mailto:"shrikantmaid99@gmail.com">webmaster</a>
            	<div class="fr">Copyright 2017 <a href="default.php">SHRI JWELLARS PVT LTD</a> Your Online Store &copy; <?php /*$date = date("l, d F, Y");*/echo date("Y") ?></div>
